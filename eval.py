...
#checkpoint_file="_BEST_35checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar"
# checkpoint_file = "1epoch_after_pretrain_checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar"
#checkpoint_file ='pre_NOT_BEST_36checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'
#checkpoint_file='./pretrained_model/BEST_34checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'
# checkpoint_file = './checkpoint_lr1/pre_NOT_BEST_41checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'
#checkpoint_file = 'pre_NOT_BEST_36checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'
# checkpoint_file='pre_BEST_45checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'
#checkpoint_file='pre_BEST_70checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar'
#checkpoint_file="pre_BEST_26checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar"
#checkpoint_file="./checkpoints_region_att_0/pre_BEST_42checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar"
...
# checkpoint_file="pre_BEST_45checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar"
checkpoint_file="pre_BEST_23checkpoint_coco_5_cap_per_img_5_min_word_freq.pth.tar"
...
def evaluate(beam_size):
    ...
    # For each image
    for i, (image_features, caps, caplens, allcaps,topic, attribute) in enumerate(
        ...
        while True:
            ...
            attention_weighted_encoding = decoder.attention(image_features,h1,topic)#,attribute
    ...
    # file_references = open("./result/references.txt", "w")
    # file_references.write(references)
    #
    file_hypotheses = open("./result/hypotheses_MS_k_1_run_1.txt", "w")
    file_hypotheses.write(str(sentences))
